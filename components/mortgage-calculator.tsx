        ...
        <TabsContent value="breakdown" className="mt-6">
          ...
          <div className="mt-8 bg-muted/50 p-4 rounded-lg">
            <p className="text-sm text-muted-foreground">
              <strong>Note:</strong> This calculator provides estimates only and
              should not be considered as financial advice. Actual mortgage
              terms and rates may vary. Property taxes and insurance costs are
              estimates and will vary based on location and other factors.
              Please consult with a mortgage professional for accurate
              information.
            </p>
          </div>
        </TabsContent>
